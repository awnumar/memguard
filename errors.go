...
// ErrSealed is returned when attempting to access the underlying data of a sealed Enclave.
var ErrSealed = errors.New("memguard.ErrSealed: attempted to access data of sealed container")
